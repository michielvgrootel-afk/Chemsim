...
export const aspirinReaction = {
  ...
  particleTypes: [
    { type: 'ASA', label: 'ASA', color: '#4f9cf0', shape: 'hexagon', radius: 16, mass: 1.5 },
    { type: 'H2O', label: 'H\u2082O', color: '#8a95a8', shape: 'circle', radius: 10, mass: 0.5 },
    { type: 'SAL', label: 'Sal', color: '#f0913a', shape: 'diamond', radius: 14, mass: 1 },
    { type: 'ACE', label: 'Ace', color: '#3dba7e', shape: 'triangle', radius: 12, mass: 0.8 },
  ],
